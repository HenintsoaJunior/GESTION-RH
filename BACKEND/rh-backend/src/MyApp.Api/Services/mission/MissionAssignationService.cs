...
//         {
//             var mission = await _missionRepository.GetByIdAsync(employeeId, missionId);
...
//             if (string.IsNullOrEmpty(transportStr) && mission.MissionType != "national")
//             {
//                 transportStr = "Avion";
//             }
...
//                     {
//                         runToRemove.Remove();
//                         bool isInternational = mission?.MissionType != "national";
//                         var table = new Table();
