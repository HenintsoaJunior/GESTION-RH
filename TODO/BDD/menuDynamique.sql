...
('menu_hab_2', 'habilitation-liste', 'fa-list', '/role/list', 1, 2, 'habilitation', 'administration', GETDATE(), GETDATE());

-- Navigation : recrutement
INSERT INTO menu (menu_id, menu_key, icon, link, is_enabled, position, module_id, section, created_at, updated_at) VALUES
('menu1', 'recrutement', 'fa-user-plus', '/recruitment', 1, 3, 'recruitment', 'navigation', GETDATE(), GETDATE()),
...
-- Navigation : mission
INSERT INTO menu (menu_id, menu_key, icon, link, is_enabled, position, module_id, section, created_at, updated_at) VALUES
('menu2', 'mission', 'fa-briefcase', '/mission', 1, 4, 'mission', 'navigation', GETDATE(), GETDATE()),
