...
('menu3_1', 'Liste des demandes', 'fa-list-ui', '/recrutement/demandes/liste', 1, 3, 'recrutement', 'navigation', GETDATE(), GETDATE()),
('menu3_2', 'Statistiques', 'fa-reg-chart-bar', '/recrutement/statistiques', 1, 3, 'recrutement', 'navigation', GETDATE(), GETDATE());
...
('h_rec_stats', 'menu3', 'menu3_2', GETDATE(), GETDATE());
