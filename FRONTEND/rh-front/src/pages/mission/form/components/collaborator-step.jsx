        ...
        <tbody>
          <FormRow className="dual-field-row">
            <FormFieldCell>
              ...
              />
              {fieldErrors["beneficiary.employeeId"] && fieldErrors["beneficiary.employeeId"].length > 0 && (
          ...
          <FormRow className="dual-field-row">
            <FormFieldCell>
              ...
              />
              {fieldErrors["beneficiary.transportId"] && fieldErrors["beneficiary.transportId"].length > 0 && (
